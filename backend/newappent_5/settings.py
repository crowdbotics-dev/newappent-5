"""
Django settings for newappent_5 project.
...
WSGI_APPLICATION = 'newappent_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "newappent_5 API",
    "DESCRIPTION": "API documentation for newappent_5 App",
    "VERSION": "v1",
}
